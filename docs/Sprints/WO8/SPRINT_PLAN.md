...
This Document outlines the sprint plan for week 8. Week 8 is about getting a Beta Build up and running. To that end, this week we need an executable that runs our simulation with minimal errors. It would be best to also add testing technologies.

### End of week Deliverables:

1. Docs/Sprint/W08/*
2. DOCS/presentations/W08
3. docs/SENSORS_POSITION_SPED.md v1 (Reser rules, coordinate conventions)
4. docs/scense_guide.md(How to load/select programming mat).
5. Tests_position_resers_on_takeoff.py

## Team Roles and Responsibilities

* Sprint Lead: Nyles Burton
* Build: Muna
* World: Ali
* API: Success
* SDK: Sopuru
